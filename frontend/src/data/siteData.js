...
export const industries = [
  {
    title: "IT Companies & Tech Parks",
    description: "Reliable support services for fast-growing tech environments, innovation centers, and shared office ecosystems in Hyderabad.",
    icon: Cpu,
  },
  {
    title: "Corporate Offices",
    description: "Structured facility, front-office, and workforce support for enterprise teams that need polished daily operations.",
    icon: Building,
  },
  {
    title: "Residential Apartment Complexes",
    description: "Housekeeping, support staffing, security coordination, and service management for residential communities.",
    icon: Apartment,
  },
  {
    title: "SMBs",
    description: "Scalable office support, admin coordination, and facility services tailored for small and medium businesses.",
    icon: Landmark,
  },
  {
    title: "Commercial Facilities",
    description: "Daily support for common areas, reception zones, service staff management, and vendor coordination.",
    icon: ClipboardList,
  },
  {
    title: "Industrial & Support Sites",
    description: "Operational discipline, workforce allocation, attendance handling, and site support processes for active facilities.",
    icon: Factory,
  },
];
...
export const testimonials = [
  {
    ...
    company: "Hyderabad Corporate Client",
    quote: "MNM Facilitech brought structure to our office support operations. Their staffing response was fast, and the daily coordination improved noticeably.",
  },
  {
    name: "Admin Lead",
    company: "Tech Park Occupier",
    quote: "Their team understood the pressure of workplace hygiene, front-office discipline, and vendor follow-up. Execution was professional and dependable.",
  },
  {
    name: "Facility Coordinator",
    company: "Commercial Office",
    quote: "The onboarding speed and payroll coordination made a real difference. We saw smoother staffing continuity and fewer operational gaps.",
  },
];
...
export const highlights = [
  {
    ...
    description: "We align workforce execution with attendance, payroll, and statutory support workflows.",
  },
  {
    title: "Faster Mobilization",
    description: "Our processes help clients onboard support teams quickly and reduce delays during expansion.",
  },
  {
    title: "Facilities Expertise",
    description: "We support daily office functionality through structured service delivery and responsive coordination.",
  },
];
